...
Public Class WinRead
    ...
    Declare Auto Function SendMessage Lib "user32.dll" (ByVal hWnd As IntPtr, ByVal msg As Integer, ByVal wParam As Integer, ByVal lParam As IntPtr) As IntPtr
    ...
    Public Declare Function SendMessageSTRING Lib "user32.dll" Alias "SendMessageA" (ByVal hwnd As Int32,
   ByVal wMsg As Int32, ByVal wParam As Integer, ByVal lParam As String) As Int32
  ...
  ByVal lpsz2 As String) As Int32
    ...
    Private Declare Function SendMessage Lib "user32" Alias "SendMessageA" (ByVal hwnd As Int32, ByVal wMsg As Int32, ByVal wParam As Integer, ByVal lParam As Int32) As Int32

    ' Get window text signature.
    Private Declare Function SendMessage Lib "user32" Alias "SendMessageA" (ByVal hwnd As Int32, ByVal wMsg As Int32, ByVal wParam As Integer, ByVal lParam As StringBuilder) As Int32
    ...
    Public Overloads Function GetChildWindows(ByVal hwnd As IntPtr) As List(Of ApiWindow)
    ...
    Public Overloads Function GetChildWindows(ByVal hwnd As IntPtr, ByVal childClass As String) As List(Of ApiWindow)
