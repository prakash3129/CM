...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		public TaskbarNotifier()
		{
            ...
            SetCloseBitmap(new Bitmap(GetType(), "close.bmp"), Color.FromArgb(255, 0, 255), new Point(204, 7));
            TitleRectangle = new Rectangle(50, 18, 150, 15);
            ContentRectangle = new Rectangle(10, 35, 210, 68);
            base.Show();
			base.Hide();
		...
		protected void OnTimer(Object obj, EventArgs ea)
		{
			...
			{
				case TaskbarStates.appearing:
					if (Height < BackgroundBitmap.Height + 3)
