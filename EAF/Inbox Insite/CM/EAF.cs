        ...
        public DataTable Validation(List<DataTable> lstDatable)
        {
            ...
            try
            {
                ...
                DataTable dtMasterContacts = Table(lstDatable, "MasterContact");
                {
                    ...
                    DataRow[] drrContactsToValidate = dtMasterContacts.Select("(TR_CONTACT_STATUS IN (" + sTREmailCheckContactStatus + ") OR WR_CONTACT_STATUS IN (" + sWREmailCheckContactStatus + "))");
