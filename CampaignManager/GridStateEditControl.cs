...
namespace GCC
{
    ...
    public class GridStateEditControl : StateControl1, IGridCellEditControl
    {
        ...
        private List<string> lstScrapperGrids = new List<string>();
        ...
        public GridStateEditControl()
        {
            ...
            lstScrapperGrids.Add("sdgvPending");
            lstScrapperGrids.Add("sdgvReady");
            lstScrapperGrids.Add("sdgvDuplicate");
            lstScrapperGrids.Add("sdgvInvalid");
            lstScrapperGrids.Add("sdgvArchive");
        }
