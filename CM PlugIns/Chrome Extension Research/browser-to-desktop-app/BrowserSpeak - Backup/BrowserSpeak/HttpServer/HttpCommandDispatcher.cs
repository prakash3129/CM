    ...
    public class HttpCommandDispatcher
    {
        ...
        private void DispatchCommand(HttpListenerContext context)
        {
            ...
            if (url.EndsWith("/dummy.gif"))
            {
                ...
                //response.ContentLength64 = Encoding.ASCII.GetBytes("Sample text displayed").Length;
                //output.Write(Encoding.ASCII.GetBytes("Sample text displayed"), 0, Encoding.ASCII.GetBytes("Sample text displayed").Length);
            }
