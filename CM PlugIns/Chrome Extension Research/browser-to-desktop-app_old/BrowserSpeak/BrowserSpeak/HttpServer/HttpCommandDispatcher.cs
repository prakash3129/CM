...
namespace HttpServer
{
    public class HttpCommandDispatcher
    {
        ...
        private void DispatchCommand(HttpListenerContext context)
        {
            ...
            string responseString1 = string.Format("<html><head><title>Browser Speak Error</title></head><body><p>The command '{0}' is not supported by Browser Speak.</p></body></html>", request.RawUrl);
            byte[] buffer1 = System.Text.Encoding.UTF8.GetBytes(responseString1);
