...
namespace VortexDial
{
	...
	public delegate void _IVortexPhoneEvents_OnInitializedEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg);
	public delegate void _IVortexPhoneEvents_OnLineSwichedEventHandler(int lineId);
	public delegate void _IVortexPhoneEvents_OnEstablishedCallEventHandler([MarshalAs(UnmanagedType.BStr)]string adress, int lineId);
	public delegate void _IVortexPhoneEvents_OnIncomingCallEventHandler([MarshalAs(UnmanagedType.BStr)]string adress, int lineId);
	public delegate void _IVortexPhoneEvents_OnClearedCallEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg, int status, int lineId);
	public delegate void _IVortexPhoneEvents_OnVolumeUpdatedEventHandler(int IsMicrophone, int level);
	public delegate void _IVortexPhoneEvents_OnRegisteredEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg);
	public delegate void _IVortexPhoneEvents_OnUnRegisteredEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg);
	public delegate void _IVortexPhoneEvents_OnPlayFinishedEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg);
	public delegate void _IVortexPhoneEvents_OnEstablishedConnectionEventHandler([MarshalAs(UnmanagedType.BStr)]string addrFrom, [MarshalAs(UnmanagedType.BStr)]string addrTo, int connectionId, int lineId);
	public delegate void _IVortexPhoneEvents_OnClearedConnectionEventHandler(int connectionId, int lineId);
	public delegate void _IVortexPhoneEvents_OnToneReceivedEventHandler(int tone, int connectionId, int lineId);
	public delegate void _IVortexPhoneEvents_OnTextMessageReceivedEventHandler([MarshalAs(UnmanagedType.BStr)]string from, [MarshalAs(UnmanagedType.BStr)]string message);
	public delegate void _IVortexPhoneEvents_OnPhoneNotifyEventHandler([MarshalAs(UnmanagedType.BStr)]string message);
	public delegate void _IVortexPhoneEvents_OnRemoteAlertingEventHandler(int connectionId, int responseCode, [MarshalAs(UnmanagedType.BStr)]string reasonMsg);
	public delegate void _IVortexPhoneEvents_OnHoldCallEventHandler(int LineId, int isHeld);
	public delegate void _IVortexPhoneEvents_OnTextMessageSentStatusEventHandler([MarshalAs(UnmanagedType.BStr)]string address, [MarshalAs(UnmanagedType.BStr)]string reason, int bSuccess);
	public delegate void _IVortexPhoneEvents_OnRecordFinishedEventHandler([MarshalAs(UnmanagedType.BStr)]string message);
	public delegate void _IVortexPhoneEvents_OnSubscribeStatusEventHandler(int subscriptionId, int statusCode, [MarshalAs(UnmanagedType.BStr)]string statusMsg);
	public delegate void _IVortexPhoneEvents_OnUnSubscribeStatusEventHandler(int subscriptionId, int statusCode, [MarshalAs(UnmanagedType.BStr)]string statusMsg);
	public delegate void _IVortexPhoneEvents_OnSubscriptionRequestEventHandler([MarshalAs(UnmanagedType.BStr)]string fromUri, [MarshalAs(UnmanagedType.BStr)]string eventStr);
	public delegate void _IVortexPhoneEvents_OnSubscriptionNotifyEventHandler(int subscriptionId, [MarshalAs(UnmanagedType.BStr)]string StateStr, [MarshalAs(UnmanagedType.BStr)]string NotifyStr);
	public delegate void _IVortexPhoneEvents_OnDetectedAnswerTimeEventHandler(int TimeSpanMs, int ConnectionId);
	public delegate void _IVortexPhoneEvents_OnBaudotToneReceivedEventHandler(int Tone, int ConnectionId, int LineId);
	public delegate void _IVortexPhoneEvents_OnSubscriptionTerminatedEventHandler([MarshalAs(UnmanagedType.BStr)]string fromUri);
	public delegate void _IVortexPhoneEvents_OnToneDetectedEventHandler(ToneType type, [MarshalAs(UnmanagedType.BStr)]string ToneStr, int ConnectionId, int LineId);
	public delegate void _IVortexPhoneEvents_OnReceivedSipNotifyMsgEventHandler([MarshalAs(UnmanagedType.BStr)]string SipNotifyMsgStr);
	public delegate void _IVortexPhoneEvents_OnPlayFinished2EventHandler([MarshalAs(UnmanagedType.BStr)]string Msg, int LineId);
	public delegate void _IVortexPhoneEvents_OnRemoteAlerting2EventHandler(int ConnectionId, int LineId, int responseCode, [MarshalAs(UnmanagedType.BStr)]string reasonMsg);
	public delegate void _IVortexPhoneEvents_OnReceivedRequestInfoEventHandler(int ConnectionId, int LineId, [MarshalAs(UnmanagedType.BStr)]string contentType, [MarshalAs(UnmanagedType.BStr)]string body);
	public delegate void _IVortexPhoneEvents_OnBaudotFinishedEventHandler([MarshalAs(UnmanagedType.BStr)]string Msg, int LineId);
...
//#endif
	...
	public class VortexPhone : IDisposable
	{
		...
		public event _IVortexPhoneEvents_OnInitializedEventHandler			OnInitialized;
		public event _IVortexPhoneEvents_OnLineSwichedEventHandler			OnLineSwiched;
		public event _IVortexPhoneEvents_OnEstablishedCallEventHandler		OnEstablishedCall;
		public event _IVortexPhoneEvents_OnIncomingCallEventHandler			OnIncomingCall;
		public event _IVortexPhoneEvents_OnClearedCallEventHandler			OnClearedCall;
		public event _IVortexPhoneEvents_OnVolumeUpdatedEventHandler			OnVolumeUpdated;
		public event _IVortexPhoneEvents_OnRegisteredEventHandler				OnRegistered;
		public event _IVortexPhoneEvents_OnUnRegisteredEventHandler			OnUnRegistered;
		public event _IVortexPhoneEvents_OnPlayFinishedEventHandler			OnPlayFinished;
		public event _IVortexPhoneEvents_OnEstablishedConnectionEventHandler	OnEstablishedConnection;
		public event _IVortexPhoneEvents_OnClearedConnectionEventHandler		OnClearedConnection;
		public event _IVortexPhoneEvents_OnToneReceivedEventHandler			OnToneReceived;
		public event _IVortexPhoneEvents_OnTextMessageReceivedEventHandler	OnTextMessageReceived;
		public event _IVortexPhoneEvents_OnPhoneNotifyEventHandler			OnPhoneNotify;
		public event _IVortexPhoneEvents_OnRemoteAlertingEventHandler			OnRemoteAlerting;
		public event _IVortexPhoneEvents_OnHoldCallEventHandler				OnHoldCall;
		public event _IVortexPhoneEvents_OnTextMessageSentStatusEventHandler	OnTextMessageSentStatus;
		public event _IVortexPhoneEvents_OnRecordFinishedEventHandler			OnRecordFinished;

		public event _IVortexPhoneEvents_OnSubscribeStatusEventHandler		OnSubscribeStatus;
		public event _IVortexPhoneEvents_OnUnSubscribeStatusEventHandler		OnUnSubscribeStatus;
		public event _IVortexPhoneEvents_OnSubscriptionRequestEventHandler	OnSubscriptionRequest;
		public event _IVortexPhoneEvents_OnSubscriptionNotifyEventHandler		OnSubscriptionNotify;
		public event _IVortexPhoneEvents_OnDetectedAnswerTimeEventHandler		OnDetectedAnswerTime;
		public event _IVortexPhoneEvents_OnBaudotToneReceivedEventHandler		OnBaudotToneReceived;
		public event _IVortexPhoneEvents_OnSubscriptionTerminatedEventHandler	OnSubscriptionTerminated;
		public event _IVortexPhoneEvents_OnToneDetectedEventHandler			OnToneDetected;
		public event _IVortexPhoneEvents_OnReceivedSipNotifyMsgEventHandler	OnReceivedSipNotifyMsg;
		public event _IVortexPhoneEvents_OnPlayFinished2EventHandler			OnPlayFinished2;
		public event _IVortexPhoneEvents_OnRemoteAlerting2EventHandler		OnRemoteAlerting2;
		public event _IVortexPhoneEvents_OnReceivedRequestInfoEventHandler	OnReceivedRequestInfo;
		public event _IVortexPhoneEvents_OnBaudotFinishedEventHandler			OnBaudotFinished;
